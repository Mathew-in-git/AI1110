...
\begin{table}[h]
	\centering
	\input{assigntable1_3}
	\caption{Pmf of outcome when a single die is tossed}
	\label{table1}
\end{table}
...
\end{align}
\begin{table}[h]
	\input{assigntable1_4}
	\caption{Cdf of outcome when a single die is tossed}
	\label{Table2}
\end{table}
...
\begin{figure}
				\centering
				\includegraphics[scale=0.5,width=\columnwidth]{assign1_6.png}
...
\begin{figure}
			\centering
			\includegraphics[width=\columnwidth]{assign1_5.png}
